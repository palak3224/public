  ...
  const services = [
    {
      ...
      description: "Accurate and timely payroll processing to ensure your employees are paid correctly and on time."
    },
    {
      icon: FileText,
      title: "Tax Filing and Compliance",
      description: "Handling all your payroll tax filing and compliance needs to keep you on the right side of the law."
    },
    {
      icon: Shield,
      title: "Data Security",
      description: "Robust data security measures to protect your sensitive payroll information."
    }
  ];
      ...
      <section className="relative bg-gradient-to-br from-purple-500 via-indigo-500 to-violet-500 py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/95 leading-relaxed max-w-3xl mx-auto mb-12">
            Our payroll management services ensure that your employees are paid accurately and on time, while keeping you compliant with all relevant regulations.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="rounded-3xl overflow-hidden shadow-2xl">
            <img 
              src="https://paybooks.in/wp-content/uploads/2025/03/payroll-processing-services.jpeg" 
              alt="Payroll Management"
              className="w-full h-full object-cover"
            />
          </div>
          <div>
            <h2 className="text-sm font-bold text-purple-600 uppercase tracking-wider mb-4">Why Outsource Your Payroll</h2>
            <h3 className="text-4xl font-bold text-slate-800 mb-6">
              Focus on What You Do Best
            </h3>
            <p className="text-slate-600 leading-relaxed text-lg mb-8">
              Outsourcing your payroll allows you to focus on your core business, while we handle the complexities of payroll processing, tax filing, and compliance. It's a cost-effective way to ensure accuracy and peace of mind.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-3xl p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Let us handle your payroll so you can focus on growing your business. Contact us today for a free consultation.
              </p>
              <Link to="/contact">

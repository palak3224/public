  ...
  const services = [
    {
      ...
      description: "Finding skilled professionals for your short-term projects and seasonal needs."
    },
    {
      icon: FileText,
      title: "Contract-to-Hire",
      description: "Assess a candidate's fit on a contract basis before making a long-term commitment."
    },
    {
      icon: Users,
      title: "Specialized Expertise",
      description: "Access to a network of professionals with specialized expertise for your specific project needs."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50">
      ...
      <section className="relative bg-gradient-to-br from-purple-500 via-indigo-500 to-violet-500 py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/95 leading-relaxed max-w-3xl mx-auto mb-12">
            Our temporary and contract staffing services provide you with the flexibility to manage your workforce and respond to changing business needs.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-bold text-slate-800">Flexible Solutions for Your Business</h3>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-sm font-bold text-purple-600 uppercase tracking-wider mb-4">Why Use Temporary & Contract Staff</h2>
            <h3 className="text-4xl font-bold text-slate-800 mb-6">
              Agility and Expertise When You Need It
            </h3>
            <p className="text-slate-600 leading-relaxed text-lg mb-8">
              Temporary and contract staff provide the agility to scale your workforce up or down as needed. It also gives you access to specialized skills for specific projects without the long-term commitment of a permanent hire.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-3xl p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Need Flexible Staffing?
              </h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Let us help you find the right temporary or contract staff for your business. Contact us today.
              </p>
              <Link to="/contact">

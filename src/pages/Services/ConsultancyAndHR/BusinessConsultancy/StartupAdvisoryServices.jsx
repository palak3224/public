...
import { ArrowRight, Rocket, Lightbulb, DollarSign } from 'lucide-react';

const StartupAdvisoryServices = () => {
  const services = [
    {
      icon: Rocket,
      title: "Business Model Validation",
      description: "We help you validate your business model and ensure it's ready for the market."
    },
    {
      icon: Lightbulb,
      title: "Funding Strategy",
      description: "Crafting a funding strategy to attract investors and secure the capital you need."
    },
    {
      icon: DollarSign,
      title: "Market Entry Strategy",
      description: "Developing a market entry strategy to launch your startup successfully."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50">
      ...
      <section className="relative bg-gradient-to-br from-purple-500 via-indigo-500 to-violet-500 py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/95 leading-relaxed max-w-3xl mx-auto mb-12">
            We provide expert guidance to startups at every stage of their journey, from validating their business model to securing funding and launching successfully.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-bold text-slate-800">How We Help Startups Succeed</h3>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-sm font-bold text-purple-600 uppercase tracking-wider mb-4">Why Choose Our Advisory Services?</h2>
            <h3 className="text-4xl font-bold text-slate-800 mb-6">
              Your Partner in Innovation
            </h3>
            <p className="text-slate-600 leading-relaxed text-lg mb-8">
              Navigating the startup landscape can be challenging. Our experienced advisors provide the strategic guidance and support you need to overcome obstacles and achieve your goals.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-3xl p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Let us help you turn your idea into a successful business. Get in touch with our startup advisors today.
              </p>
              <Link to="/contact">
...
export default StartupAdvisoryServices;

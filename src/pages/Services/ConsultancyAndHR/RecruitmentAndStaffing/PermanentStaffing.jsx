...
import { ArrowRight, UserPlus, Award, ClipboardCheck } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "We specialize in finding and attracting top-tier talent for leadership and executive roles."
    },
    {
      icon: Award,
      title: "Specialized Skill Hiring",
      description: "Recruiting for specialized and hard-to-find skills to meet your unique business needs."
    },
    {
      icon: ClipboardCheck,
      title: "Cultural Fit Assessment",
      description: "Ensuring that new hires not only have the right skills but also align with your company culture."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50">
      ...
      <section className="relative bg-gradient-to-br from-purple-500 via-indigo-500 to-violet-500 py-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight">
            Building Your Long-Term Team
          </h1>
          <p className="text-xl md:text-2xl text-white/95 leading-relaxed max-w-3xl mx-auto mb-12">
            Our permanent staffing solutions are designed to find you the right employees who will grow with your company for the long term.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-bold text-slate-800">How We Find Your Next Great Hire</h3>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-sm font-bold text-purple-600 uppercase tracking-wider mb-4">Why Invest in Permanent Staffing</h2>
            <h3 className="text-4xl font-bold text-slate-800 mb-6">
              Building a Cohesive and Committed Team
            </h3>
            <p className="text-slate-600 leading-relaxed text-lg mb-8">
              Permanent employees are the backbone of your company. We help you find dedicated professionals who are invested in your company's success and will contribute to a positive and productive work environment.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-indigo-500 rounded-3xl p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Ready to Find Your Next Long-Term Employee?
              </h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Let us help you find the perfect addition to your team. Contact our permanent staffing specialists today.
              </p>
              <Link to="/contact">
